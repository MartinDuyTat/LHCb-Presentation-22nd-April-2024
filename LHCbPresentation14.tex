...
\usepackage{pifont} % Custom bullet points
\usepackage[many]{tcolorbox} % Figure border

% Here's where the presentation starts, with the info for the title slide
\title[$h^+h^-\pi^+\pi^-$]{Model-independent measurement of \texorpdfstring{$\gamma$}{gamma} in \texorpdfstring{$B^\pm\to[h^+h^-\pi^+\pi^-]_Dh^\pm$}{B2DhD2hhpipi} at LHCb and BESIII}
...
\begin{frame}{Introduction}
  \begin{center}
    \large{\underline{Last presentation} since starting my PhD journey 1295 days ago!}
  \end{center}
  \vspace{0.1cm}
  \begin{enumerate}
...
\begin{frame}{Summary and next steps}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      My thesis is slowly taking shape...
      \vspace{0.5cm}
      {\scriptsize
      \begin{itemize}
        \item[\ding{111}]{1. Introduction}
        \item[\ding{051}]{2. Theoretical background}
        \item[\ding{111}]{3. Optimised binning scheme for $D^0\to K^+K^-\pi^+\pi^-$}
        \item[\ding{111}]{4. The BESIII detector}
        \item[\ding{111}]{5. Selection of single- and double-tag events}
        \item[\ding{111}]{6. Measurement of strong-phase differences}
        \item[\ding{111}]{7. The LHCb detector}
        \item[\ding{111}]{8. Selection of $B^\pm\to[h^+h^-\pi^+\pi^-]_Dh^\pm$ events}
        \item[\ding{111}]{9. Model-independent measurement of $\gamma$}
        \item[\ding{111}]{10. Summary and outlook}
      \end{itemize}}
      \vspace{0.4cm}
    ... I will do my best to stop procrastinating!
    \end{column}
    \begin{column}{0.4\textwidth}
      ...
      \begin{tcolorbox}[beamer,
        ...
        \includegraphics[width=1.0\textwidth]{Plots/PhDThesis_MartinDuyTat_FrontPage.pdf}
      \end{tcolorbox}
    \end{column}
  \end{columns}
\end{frame}
